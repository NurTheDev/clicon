            ...
            <Container>
                <div className={"grid grid-cols-1 lg:grid-cols-12 gap-4"}>
                    <div className={"lg:col-span-3 bg-warning-300 flexColumnCenter h-full   "}>
                        ...
                        <img src={assets.featureProductBg} alt="" className={"w-full object-cover"}/>
                    </div>
                    <div className={"lg:col-span-9 h-full"}>
                        <div className={"flex flex-col items-center lg:flex-row lg:justify-between gap-y-4 lg:gap-y-0"}>
                            ...
                            <div className="overflow-x-auto scrollbar-hide">
                                <ul className="flex flex-wrap lg:flex-nowrap lg:min-w-max justify-center md:justify-end items-center gap-4 sm:gap-6 mt-4 px-2 sm:px-0">
                                    {featuredSortlinks?.slice(0, 6).map((item: {
                                        url: string,
                                        slug: string,
                                        name: string
                                    }, index: number) => (
                        ...
                        <div className={"flexColumnCenter gap-y-5"}>
                            ...
                            <div
                                className={"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 mt-6 gap-4 lg:gap-x-6 lg:gap-y-4"}>
                                {isLoading ?
                                    <ProductCardSkeleton/> : products?.slice(0, 8).map((product: ProductDataType) => (
