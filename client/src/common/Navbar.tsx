            ...
            <Container>
                <div className={"grid grid-cols-4 gap-4 justify-between items-center font-public-sans"}>
                    ...
                    <div className={"col-span-2 relative"}>
                        <input type="text" placeholder={"Search for anything......"} className={"bg-gray-00" +
                            " text-gray-900 w-full py-3 px-4 rounded-xs placeholder:text-gray-400 focus:outline-none"}/>
                        <span className={"absolute right-5 top-1/2 transform -translate-y-1/2 cursor-pointer z-10" +
                            " text-gray-900"}>{Icons.search}</span>
                    </div>
                    <div>
